...
// A simple Home icon component for the button
const HomeIcon = () => (
    <svg 
...
const MapPage = () => {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden">
        {/* Home Button */}
        <Link href="/" className="absolute top-4 left-16 z-[1000] flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-xl border border-slate-400/50 rounded-lg text-slate-800 font-semibold hover:bg-white/40 transition-colors shadow-lg">
            <HomeIcon />
            <span>Home</span>
        </Link>
        ...
        {/* Slide-in panel */}
        <div
            className={`absolute top-0 right-0 h-full w-full sm:w-1/2 md:w-1/3 bg-white/20 backdrop-blur-xl border-l border-slate-400/50 shadow-2xl z-[1000] transform transition-transform duration-300 ease-in-out ${
